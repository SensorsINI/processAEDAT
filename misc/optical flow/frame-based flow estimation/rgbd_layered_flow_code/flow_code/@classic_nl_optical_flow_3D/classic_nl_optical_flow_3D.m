function this = classic_nl_optical_flow_3D(varargin)
%
%CLASSIC_NL_OPTICAL_FLOW_3D   
...
%       
%   CLASSIC_NL_OPTICAL_FLOW_3D([IMGS]) constructs an  optical flow object
%   with the optional image sequence IMGS ([n x m x 2] array). 
%   CLASSIC_NL_OPTICAL_FLOW_3D(O) constructs BA optical flow object by copying O.
%  
%   This is a member function of the class 'classic_nl_optical_flow_3D'. 
%
...
error(nargchk(0, 1, length(varargin)));
  ...
  switch (length(varargin))
    case 0
      ...
      this = class(this, 'classic_nl_optical_flow_3D');         
      
    case 1
      if isa(varargin{1}, 'classic_nl_optical_flow_3D')
        this = varargin{1};        
      else    
          this = classic_nl_optical_flow_3D;
