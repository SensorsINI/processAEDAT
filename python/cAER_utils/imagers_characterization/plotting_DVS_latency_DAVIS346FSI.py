...
####################################################
DVS_ircut_data_file = 'Z:/Characterizations/Measurements_final/346F/latency/' \
                            'DAVIS346B_latency_irc_05_08_16-16_58_12/' \
                            'saved_variables/variables.npz'
DVS_ircut_nd1_data_file = 'Z:/Characterizations/Measurements_final/346F/latency/' \
                                'DAVIS346B_latency_irc_nd1_05_08_16-16_53_51/' \
                                'saved_variables/variables.npz'
DVS_ircut_nd2_data_file = 'Z:/Characterizations/Measurements_final/346F/latency/' \
                                'DAVIS346B_latency_irc_nd2_05_08_16-16_56_18/' \
                                'saved_variables/variables.npz'
...
plt.savefig(output_dir + "DVS_latency_irc_DAVIS346FSI.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_DAVIS346FSI.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_irc_nd1_DAVIS346FSI.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_nd1_DAVIS346FSI.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_irc_nd2_DAVIS346FSI.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_nd2_DAVIS346FSI.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_illumination_DAVIS346FSI.png", format='png', bbox_inches='tight', dpi=600)
