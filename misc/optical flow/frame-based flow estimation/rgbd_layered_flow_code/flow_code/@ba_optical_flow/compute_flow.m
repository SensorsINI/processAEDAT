...
gnc_pyramid_images = data.gnc_pyramid_images;
pyramid_images     = data.pyramid_images;
  ...
  for ignc = 1:this.gnc_iters     
      ...
      for l = pyramid_levels:-1:1
          ...
          if (l==1) && (ignc==this.gnc_iters) && this.noMFlastlevel
              small.median_filter_size = [];
          end;
      ...
      if this.display
          ...
          if nargin == 3
              ...
              fprintf('AAE %3.6f STD %3.3f average end point error %3.3f \n', aae, stdae, aepe);
          end;
  ...
  % mainly improves H&S, slightly improves others
