...
plt.plot(wavelength_R[1:-1], cg_scale*100.0*(QE_R[0,1:-1,0,0]), 'o-', color='r', markersize=5, markerfacecolor='r', markeredgecolor='r', label='Red')
plt.plot(wavelength_G[1:-1], cg_scale*100.0*(QE_G[0,1:-1,0,0]), 'o-', color='g', markersize=5, markerfacecolor='g', markeredgecolor='g', label='Green')
plt.plot(wavelength_B[1:-1], cg_scale*100.0*(QE_B[0,1:-1,0,0]), 'o-', color='b', markersize=5, markerfacecolor='b', markeredgecolor='b', label='Blue')
plt.plot(wavelength_MONO[1:-1], cg_scale*100.0*(QE_MONO[0,1:-1,0,0]), 'o-', color='k', markersize=5, markerfacecolor='w', markeredgecolor='k', label='Mono')
