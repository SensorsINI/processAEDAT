...
%     fprintf('unequal sampling\n');
    ...
    data.org_pyramid_depths = compute_image_pyramid_unequal(this.depths,...
        this.pyramid_levels, spacing, factor);
else
    ...
    data.org_pyramid_depths = compute_image_pyramid(this.depths, f,...
        this.pyramid_levels, 1/this.pyramid_spacing);
end
...
data.org_gnc_pyramid_depths = compute_image_pyramid(this.depths,...
    f, this.gnc_pyramid_levels, 1/this.gnc_pyramid_spacing);
