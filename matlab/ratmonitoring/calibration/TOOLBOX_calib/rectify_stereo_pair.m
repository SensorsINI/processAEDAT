...
save_to_ascii('indices_droite1',ind_1_right);
save_to_ascii('indices_droite2',ind_2_right);
save_to_ascii('indices_droite3',ind_3_right);
save_to_ascii('indices_droite4',ind_4_right);
save_to_ascii('indices_new_droite',ind_new_right);

save_to_ascii('indices_gauche1',ind_1_left);
save_to_ascii('indices_gauche2',ind_2_left);
save_to_ascii('indices_gauche3',ind_3_left);
save_to_ascii('indices_gauche4',ind_4_left);
save_to_ascii('indices_new_gauche',ind_new_left);
...
% modified by rogister to fit his file tree structure    
calib_name_left = ['./gauche/' calib_name_left]
calib_name_right = ['./droite/' calib_name_right]
