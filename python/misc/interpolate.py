...
filename = '/home/federico/Dropbox/FaceDetectionMattiaCorradi/Data/Raw/Fabian/DAVIS240_09102015_0_m_bus_label.txt'
outputfilename = '/home/federico/Dropbox/FaceDetectionMattiaCorradi/Data/Raw/Fabian/DAVIS240_09102015_0_m_bus_label_interpolated.txt'
...
frame_ts = np.linspace(np.min(data[:, 0]), np.max(data[:, 0]), len(all_ts))
