function [uvo sego occo flowEdgeo] = estimate_flow_interface(im1, im2, method, outFn, params) 
%%
...
if nargout <= 1
    ...
    [uv seg occ flowEdge]  = compute_flow(ope, zeros([size(im1,1) size(im1,2) 2]));
end
