...
function a = rat_smooth_plot_avi(exp_data,smooth_factor,colorc,label)
label
...
%  i = 1;
  ...
  for n=2:length(xdata3)         
            plot3(xdata3(n-1:n)*0.04,ydata3(n-1:n)*0.04,zdata3(n-1:n)*0.04,'g.'); 
   
            plot3(xdata(n-1:n)*0.04,ydata(n-1:n)*0.04,zdata(n-1:n)*0.04,'b');    
