...
# CONNECT TO MACHINES
###############################################################################
caer_control = caer_communication.caer_communication(host=host_ip, port_control=caer_port_command, port_data = caer_port_data)
labview_control = labview_communication.labview_communication(host=labview_host, port_data=labview_port)
...
if measure_qe:
    if(labview_control.check_connection == True):
        ...
        if(labview_control.check_error == True):
