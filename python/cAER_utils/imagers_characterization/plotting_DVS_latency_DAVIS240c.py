...
####################################################
DVS_ircut_data_file = 'Z:/Characterizations/Measurements_final/DAVIS240C/latency/' \
                            'DAVIS240C_latency_irc_28_07_16-16_55_13/' \
                            'saved_variables/variables.npz'
DVS_ircut_nd1_data_file = 'Z:/Characterizations/Measurements_final/DAVIS240C/latency/' \
                                'DAVIS240C_latency_irc_nd1_28_07_16-17_00_44/' \
                                'saved_variables/variables.npz'
DVS_ircut_nd2_data_file = 'Z:/Characterizations/Measurements_final/DAVIS240C/latency/' \
                                'DAVIS240C_latency_irc_nd2_28_07_16-17_03_35/' \
                                'saved_variables/variables.npz'
...
plt.savefig(output_dir + "DVS_latency_irc_DAVIS240C.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_DAVIS240C.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_irc_nd1_DAVIS240C.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_nd1_DAVIS240C.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_irc_nd2_DAVIS240C.pdf", format='pdf', bbox_inches='tight')
plt.savefig(output_dir + "DVS_latency_irc_nd2_DAVIS240C.png", format='png', bbox_inches='tight', dpi=600)
...
plt.savefig(output_dir + "DVS_latency_illumination_DAVIS240C.png", format='png', bbox_inches='tight', dpi=600)
